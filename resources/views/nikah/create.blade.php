                    ...
                    <div class="card-body">
                      <h4 class="card-title">Tambah Data Pencatatan Nikah</h4>
                        ...
                        <div class="form-group{{ $errors->has('anggota_id') ? ' has-error' : '' }}">
                            <label for="anggota_id" class="col-md-4 control-label">Nama Suami</label>
                            <div class="col-md-6">
                        ...
                        <a href="{{route('nikah.index')}}" class="btn btn-light pull-right">Back</a>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <th>
                          ...
                          <th>
                            ...
                            <tbody>
                                ...
                                <tr class="pilih_suami" data-anggota_id="<?php echo $data->id; ?>" data-suami_judul="<?php echo $data->nama; ?>" >
                                    <td class="py-1">
                            {{$data->nama}}
                          </td>
                          <td>
